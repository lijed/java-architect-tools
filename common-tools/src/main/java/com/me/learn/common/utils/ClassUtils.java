...
package com.me.learn.common.utils;

import com.me.learn.common.exception.CommonRuntimeException;

import static com.me.learn.common.exception.CommonException.SERVER_ERROR;
...
public final class ClassUtils {
    ...
    public static Class findClassByName(String className) {
        try {
            ...
            throw new CommonRuntimeException("this class name not found",SERVER_ERROR);
        }
    }
