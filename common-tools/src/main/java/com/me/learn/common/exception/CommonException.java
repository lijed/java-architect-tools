...
import com.me.learn.common.Constants;
...
public class CommonException extends Exception {
    ...
    public CommonException(final int errCode, final Throwable throwable) {
        super(throwable);
        this.errCode = errCode;
        this.setCauseThrowable(throwable);
    }

    public CommonException(final int errCode, final String errMsg, final Throwable throwable) {
