...
import static com.me.learn.event.EventListener.findEventType;
...
public abstract class AbstractEventDispatcher implements EventDispatcher {
    ...
    protected Stream<EventListener> sortedListeners(Predicate<Map.Entry<Class<? extends com.me.learn.event.Event>, List<EventListener>>> predicate) {
