...
import com.me.learn.notify.commons.JustForTest;
import com.me.learn.notify.exception.NotifyRunTimeException;
import com.me.learn.notify.listener.SmartSubscriber;
import com.me.learn.notify.listener.Subscriber;
import com.me.learn.notify.utils.ClassUtils;
import com.me.learn.notify.utils.MapUtils;
import com.me.learn.notify.utils.ThreadUtils;
...
import static com.me.learn.notify.exception.NofityException.SERVER_ERROR;
        ...
        publisherFactory = new BiFunction<Class<? extends Event>, Integer, EventPublisher>() {
            ...
            public EventPublisher apply(Class<? extends Event> cls, Integer buffer) {
                try {
                    ...
                    //publisher的初始化，完成线程startup
                    publisher.init(cls, buffer);
                    return publisher;
                } catch (Throwable ex) {
                    LOGGER.error("Service class newInstance has error : {}", ex);
                    throw new NotifyRunTimeException(SERVER_ERROR, ex);
                }
            }
        };
